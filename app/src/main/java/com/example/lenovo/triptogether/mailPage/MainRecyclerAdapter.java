...
public class MainRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MainRecyclerAdapter(MailFragment context) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        baseViewHolder.mViewContent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //点击事件
                Intent intent = new Intent(mContext,ChatContent.class);
                Bundle bundle = new Bundle();
                bundle.putInt("mailImage",mDatas.get(position).contactImage);
                bundle.putString("Name",mDatas.get(position).title);
    ...
    class ItemBaseViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemBaseViewHolder(View itemView) {
            ...
            mTextContext = (TextView) itemView.findViewById(R.id.text_list_main_context) ;
            mImage = (ImageView) itemView.findViewById(R.id.mailImage);
...
//            mTextIndex.setText("#" + testModel.position);
            mTextContext.setText(testModel.ChatContext);
            mImage.setBackgroundResource(testModel.contactImage);
