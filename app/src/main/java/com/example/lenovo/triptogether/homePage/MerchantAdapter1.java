 ...
 */
public class MerchantAdapter1 extends RecyclerView.Adapter<MerchantAdapter1.ViewHolder> implements View.OnClickListener{
    ...
    public MerchantAdapter1(Context context, ArrayList<Merchant> items)
    {
        super();
        merchant_list = items;
    ...
    {
        View view = mInflater.inflate(R.layout.life_item, viewGroup, false);
        ViewHolder holder = new ViewHolder(view);
        holder.Image = (ImageView)view.findViewById(R.id.merchantType1_image);
        holder.Service = (TextView)view.findViewById(R.id.merchantType1_service);
        holder.Price =(TextView)view.findViewById(R.id.merchantType1_price);
        holder.Address = (TextView)view.findViewById(R.id.merchantType1_address);
        return holder;
    }
    @Override
